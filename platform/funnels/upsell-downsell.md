...
そして最後に、アップセルオファーを購入した顧客を購読者リストに追加したり、タグを追加してセグメント化するオプションもあります。これは、購入しなかった顧客へのリターゲティングに最適です。
...
4. アップセルを編集し、製品を追加し、コール・トゥ・アクションボタンをカスタマイズします。価格の変更、辞退リンクの追加、顧客を購読者リストやセグメントに追加することも可能です。
