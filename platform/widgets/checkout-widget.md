...
毎月のお支払い（サブスクリプション商品）に、初回だけ入会金を足したい場合も、バンプオファーで設定できます。

はじめに、月謝の商品と入会金の商品を、それぞれ別々に作成しておきます。そのうえで、申し込みページに置いたチェックアウトウィジェットで次のように設定します。

1. 「主な商品」に、月謝のサブスクリプション商品を選ぶ
2. 「バンプオファー」に、入会金の商品を選ぶ

<figure><img src="../../.gitbook/assets/checkout-bump-products-panel.png" alt=""><figcaption></figcaption></figure>

つづいて、バンプオファーの「編集」を開き、そのバンプの設定に入ります。ここで「デフォルトではアクティブ」にチェックを入れてください。

<figure><img src="../../.gitbook/assets/checkout-bump-edit-modal.png" alt=""><figcaption></figcaption></figure>

「デフォルトではアクティブ」は、そのバンプを最初から選ばれた状態でカートに入れる設定です。チェックを外しておくと、お客様が自分で選ばないかぎり金額は加算されません。入会金のように必ずお支払いいただくものは、チェックを入れておきます。

あわせて「バンプの説明」に一文を添え、「バッジを表示する」のバッジテキストを「必須」にしておくと、外せないものであることがお客様に伝わります。

お客様の画面では、次のように表示されます。バンプが最初から選択された状態になり、注文の概要にも金額が反映されます。

<figure><img src="../../.gitbook/assets/checkout-bump-live-view.png" alt=""><figcaption></figcaption></figure>

なお、チェックアウトを2ステップにしている場合、「バンプの位置」で「顧客情報の下、チェックアウトボタンの上」を選んでいるときは、バンプは支払情報のステップに表示されます。
...
* 顧客登録
* 配送先住所の入力
* 顧客を購読者リストに追加し、セグメンテーションのためのタグを追加
...
**メールマーケティングに接続**： 顧客が商品を購入した際に、購読者リストに追加することができます。MailChimpなどの外部プロバイダーを利用している場合は、MailChimpのリストに追加することができます。
