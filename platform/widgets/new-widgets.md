...
ページビルダーに、新しいウィジェットが16種類追加されました。
...
### 見せ方を上げる4つ <a href="#visual" id="visual"></a>
...
#### Headline Pill（見出しの上の小さなラベル）

角丸の小さな帯に、短い文字を入れるウィジェットです。料金表についている「最も人気のある」のようなバッジと同じ見た目で、見出しの上に置いて「ここから何の話か」を一言で示すのに使います。

セクションが続くページで効きます。「お客様の声」「料金」「よくある質問」のように置いていくと、読者が長いページを飛ばし読みしても迷いません。

このウィジェットに絵筆はなく、設定はすべて「編集」の中にまとまっています。文字、色、フォント、角の丸み、文字サイズ、余白をここで変えられます。

{% hint style="info" %}
**同じ見た目で揃えたいときは**\
設定の中にある「Style preset」を使うと、サイト全体で決めた見た目をそのまま当てられます。ページごとに色を決め直さずに済むので、複数のセクションで使うなら最初からこちらがおすすめです。
{% endhint %}
