...
グリッド・カルーセル・**グリッド配置**の3つのスタイルから選択できます。**グリッド**レイアウトは、追加したすべての画像を静的なフォーマットで表示します。**カルーセル**は、画像に動きをつけたり、ユーザーの手動入力で画像をスクロールさせたりすることができます。**グリッド配置**は、縦横のサイズが異なる画像をレンガのように敷き詰めて表示するレイアウトで、Pinterestのような見た目にしたいときに向いています。
...
画像をトリミングして表示する際、どの部分を中心に見せるかを指定できます。画像の上に表示される丸いポイントをドラッグし、切り抜きの基準にしたい焦点（フォーカルポイント）を、見せたい位置（人の顔など）に合わせてください。サイズの異なる画像が混在するグリッド・グリッド配置レイアウトで、被写体が見切れてしまうのを防げます。

<figure><img src="../../.gitbook/assets/gallery-widget-focal-point.png" alt=""><figcaption></figcaption></figure>
