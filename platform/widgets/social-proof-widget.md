...
**言葉を自由に決められます。** 「下に表示する文章」の欄で、「延べ200名の講師にご利用いただいています」のように、伝えたい実績を書けます。

### 設定項目

| 項目 | 内容 |
|---|---|
| プロフィール画像を表示 | 顔写真を並べるかどうか。追加・削除・並び替えができます |
| 評価の数値を表示 | 数字と星を出すかどうか |
| 評価・スコア | 表示する数字（例: 4.9） |
| 評価のラベル | 数字の横に添える言葉（例:「の評価」） |
| 下に表示する文章 | 数字の下に置く、補足の信頼メッセージ |
| 星の色・数字と文字の色 | ブランドに合わせて調整できます |
