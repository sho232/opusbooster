...
<figure><img src="../../.gitbook/assets/image-77.png" alt=""><figcaption><p>「水平」で表示したところ</p></figcaption></figure>
...
縦の線に沿って、節目が上から下へ並びます。タイトルと日付が線の片側に、詳細カードが反対側に置かれ、項目ごとに左右が入れ替わります。項目数が多いときや、物語として読ませたいときに向いています。

<figure><img src="../../.gitbook/assets/image-78.png" alt=""><figcaption><p>「垂直」で表示したところ</p></figcaption></figure>
...
{% hint style="info" %}
「行あたりのアイテム」は、レイアウト&#x304C;**「水平」か「水平 – 詳細は下」のときだけ表示されます**&#x3002; 「垂直」では項目が縦に並ぶため、この設定自体が出てきません。
{% endhint %}
