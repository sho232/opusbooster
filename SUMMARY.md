...
* [はじめに](platform/getting-started/README.md)
  ...
  * [カスタムドメインの接続](platform/getting-started/custom-domain.md)
    * [ドメインがどこで管理されているか調べる](platform/getting-started/dns-records/where-is-my-domain.md)
    * [お名前.com でレコードを追加する](platform/getting-started/dns-records/onamae.md)
    * [エックスサーバーでレコードを追加する](platform/getting-started/dns-records/xserver.md)
    * [ムームードメインでレコードを追加する](platform/getting-started/dns-records/muumuu.md)
    * [さくらインターネットでレコードを追加する](platform/getting-started/dns-records/sakura.md)
    * [バリュードメインでレコードを追加する](platform/getting-started/dns-records/value-domain.md)
    * [Cloudflare でレコードを追加する](platform/getting-started/dns-records/cloudflare.md)
    * [Squarespace（旧 Google Domains）でレコードを追加する](platform/getting-started/dns-records/squarespace.md)
...
* [ウェブサイト＆ファネルビルダー](platform/website-funnel-builder/README.md)
  ...
  * [スマホ版だけを、パソコン版と別々に整える](platform/website-funnel-builder/mobile-editing.md)
  * [並べ方が自由になりました](platform/website-funnel-builder/layout-freedom.md)
  * [色と装飾を、1か所で決める](platform/website-funnel-builder/global-styles.md)
* [ウィジェット](platform/widgets/README.md)
  * [新しいウィジェットの使い方](platform/widgets/new-widgets.md)
  * [ベーシック](platform/widgets/basic.md)
    ...
    * [見出しウィジェット](platform/widgets/heading-text-widget.md)
    * [アイコンリストウィジェット](platform/widgets/icon-list-widget.md)
    * [テーブルウィジェット](platform/widgets/table-widget.md)
    * [スクロールテキストウィジェット](platform/widgets/scrolling-text-widget.md)
    * [ピル型見出しウィジェット](platform/widgets/headline-pill-widget.md)
    * [タイムラインウィジェット](platform/widgets/timeline-widget.md)
    * [お客様の声ウィジェット](platform/widgets/testimonial-widget.md)
    * [ソーシャルプルーフウィジェット](platform/widgets/social-proof-widget.md)
  * [メディア](platform/widgets/media.md)
    ...
    * [動画によるお客様の声ウィジェット](platform/widgets/video-testimonial-widget.md)
  * [リード獲得](platform/widgets/lead-generation.md)
    * [フォームウィジェット](platform/widgets/form-widget.md)
    * [クイズ＆アンケートウィジェット](platform/widgets/quiz-survey-widget.md)
  * [ストア](platform/widgets/store.md)
  ...
  * [その他](platform/widgets/other.md)
    ...
    * [チャートウィジェット](platform/widgets/chart-widget.md)
    * [統計カウンターウィジェット](platform/widgets/stat-counter-widget.md)
    * [チームメンバーウィジェット](platform/widgets/team-members-widget.md)
...
* [ログインできないとき（パスワードなしで入る）](extra/login-help.md)
* [集まる日（グルコン＆実践会）のZoomに入る手順](extra/join-zoom-sessions.md)
* [よくある質問](extra/faq.md)
