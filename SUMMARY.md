...
* [メッセージ & ワークフロー](platform/email-and-automation/README.md)
  * [メールドメインの接続](platform/email-and-automation/email-domain-connection.md)
    * [ドメインがどこで管理されているか調べる](platform/email-and-automation/email-domain-dns/where-is-my-domain.md)
    * [お名前.com でレコードを追加する](platform/email-and-automation/email-domain-dns/onamae.md)
    * [エックスサーバーでレコードを追加する](platform/email-and-automation/email-domain-dns/xserver.md)
    * [ムームードメインでレコードを追加する](platform/email-and-automation/email-domain-dns/muumuu.md)
    * [さくらインターネットでレコードを追加する](platform/email-and-automation/email-domain-dns/sakura.md)
    * [バリュードメインでレコードを追加する](platform/email-and-automation/email-domain-dns/value-domain.md)
    * [Cloudflare でレコードを追加する](platform/email-and-automation/email-domain-dns/cloudflare.md)
    * [Squarespace（旧 Google Domains）でレコードを追加する](platform/email-and-automation/email-domain-dns/squarespace.md)
