---
description: OpusBoosterを使い始めてから最初の7日間でやることを、1日ずつのチェックリストにした新規ユーザー向けガイド。テンプレート選択からメール設定、独自ドメイン、最初のファネル公開まで迷わず進めます。
---
...
<figure><img src=".gitbook/assets/first-7-days-template-select.png" alt=""><figcaption>テンプレート選択画面。ランディングページ・オンラインストア・ウェブサイト・ファネルからカテゴリを選びます</figcaption></figure>

<figure><img src=".gitbook/assets/first-7-days-setup-wizard.png" alt=""><figcaption>設定ウィザード。ブランドカラーとロゴを設定すると、30秒でパーソナライズされたサイトが完成します</figcaption></figure>
