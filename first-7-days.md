---
description: OpusBoosterを使い始めてから最初の7日間でやることを、1日ずつのチェックリストにした新規ユーザー向けガイド。ドメイン接続からメール設定、最初のファネル公開まで迷わず進めます。
---
...
**今日のゴール: OpusBoosterで何ができるかを理解し、基本設定を済ませる**
...
ここまでで、ドメイン・メール・サイト・決済・ファネル・発信という6つの土台が揃いました。ここから先は人によって道が分かれます。[目的別サクセスマップ](success-map.md)から、あなたのゴールの章に進んでください。
