...
<figure><img src="../.gitbook/assets/ai-profile-button.png" alt=""><figcaption>ブログ記事一覧画面。右上の「AIプロフィール設定」ボタンから開きます</figcaption></figure>
...
ページ2のさらに下には、上級者向けの任意項目として「**🌱 ドリームキーワード**」欄もあります。これを設定しておくと、[次のテーマ提案](premium-article-generator.md)が、まだ書いていないキーワードを優先して提案してくれるようになります。詳しくは[ドリーム100キーワードの使い方](dream-100-keywords.md)をご覧ください。
