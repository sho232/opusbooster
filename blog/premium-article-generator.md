---
description: AIインタビューであなたの実体験を引き出し、読者に信頼される記事を作るブログ集客AIの基本の使い方。記事タイプの選び方からCTA自動提案、公開前ファクトチェックまで、記事を1本作って公開するまでの流れを解説。
---
...
準備は最初の一度だけです。2回目からは、毎回ウィザードを回すだけで記事が作れます。このページでは、この一本道の使い方だけを解説します。慣れてきたら使える応用機能は[ブログ集客AIをもっと使いこなす](premium-article-advanced-features.md)と[公開したあとの成果を見る](premium-article-performance.md)にまとめてあります。
...
もっと賢く、狙いを持って提案してほしい場合は、[ドリーム100キーワードの使い方](dream-100-keywords.md)もあわせてご覧ください。
...
目安文字数をあとから変更すると、黄色いパネルが出て「新しい文字数で構成を再生成する」か「今の構成を保持して続行する」かを聞かれます。手で整えた見出しを残したいときは後者を選んでください。詳しくは[ブログ集客AIでつまずきやすい3つのポイント](premium-article-troubleshooting.md)をご覧ください。
...
* 「**エディタに挿入**」 — 本文とタイトルだけでなく、**カテゴリ・URLスラッグ・SEOタグ・概要までまとめて**、編集中のブログ記事に設定します。SEOタグはAIが3〜5個提案し、既存のタグと重複するものは追加されません。概要が空欄の場合は、後述の説明文案の1つ目（説明1）が自動でセットされます。自分で設定済みのタグや概要は、上書きされないのでご安心ください。なお、編集中の記事にすでに本文が入っている場合は「**既存記事の上書き確認**」が表示されます。誤って本文を消してしまわないための確認で、「キャンセル」を選べば記事はそのまま残ります
...
生成された記事のプレビューには、どの段落が「あなたの一次情報」かが色でわかる表示や、気に入らない見出しだけをピンポイントで作り直せる機能もあります。基本の使い方をひととおり終えたら、[ブログ集客AIをもっと使いこなす](premium-article-advanced-features.md)もあわせてご覧ください。
...
公開前の仕上げとして、記事全体が「読者の心を動かせる構造になっているか」を4つの視点でチェックできる**ストーリーカバレッジ**という機能もあります。特に体験談型の記事におすすめです。使い方は[ブログ集客AIをもっと使いこなす](premium-article-advanced-features.md)にまとめています。

公開したあとは、ブログ記事一覧画面の「**📊 記事の成果**」から、どの記事がどれくらい読まれているかをランキングで確認できます。伸びている記事のSNSシェアも、ワンクリックで画像と文章を用意できます。詳しくは[公開したあとの成果を見る](premium-article-performance.md)をご覧ください。
...
* **AIインタビューには具体的に答える** — 実体験・数字・エピソードを答えるほど、あなたにしか書けない記事に近づきます
...
* **慣れてきたら、もっと使いこなす機能も覗いてみる** — 見出し単位の部分再生成やストーリーカバレッジなど、記事をさらに磨き込む機能は[ブログ集客AIをもっと使いこなす](premium-article-advanced-features.md)にまとめています
* **公開したら終わりにしない** — [公開したあとの成果を見る](premium-article-performance.md)を月に一度は開いて、伸びた記事の続編を書く、伸びなかった記事のタイトルを見直すなど、改善サイクルに乗せましょう
