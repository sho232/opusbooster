...
## はじめてアプリを開く前に（パスワードの設定）

アプリのログインは、OpusBoosterに登録したメールアドレスと**パスワード**で行います。アプリには「パスワードを忘れた」のボタンがありません。**パスワードをまだ決めていない方・忘れた方は、先にブラウザーで設定してください。**

1. [ログインページ](https://opusbooster.com/login)を開き、**パスワードを忘れましたか？** を押します。
2. OpusBoosterに登録したメールアドレスを入力して送ります。
3. 届いたメールのリンクから、新しいパスワードを決めます。
4. アプリを開き、メールアドレスとそのパスワードを入れてログインします。

管理画面にログインしている方は、右上のアカウントメニューの **アカウント設定** からもパスワードを変更できます。

<figure><img src="../.gitbook/assets/mobile-app-2026-09-19-signin.png" alt="アプリのログイン画面。メールアドレスとパスワードの入力欄とログインボタン"><figcaption>アプリのログイン画面。メールアドレスとパスワードを入れてログインします</figcaption></figure>

{% hint style="warning" %}
ログイン画面の下にある新規登録のリンクは、新しくアカウントを作る方向けです。すでにOpusBoosterをお使いの方は押さないでください。ログイン用のメール（パスワードなしのログイン）はアプリでは使えません。
{% endhint %}
...
通知は、押すとその内容の画面へ移動します。移動先は通知の種類によって変わります。

| 通知 | 押すと開く画面 |
| :--- | :--- |
| **新しい注文が届きました** | その注文の詳細。入金や発送の状態をその場で変えられます |
| **新しい予約が入りました** | その予約の内容 |
| **フォームが送信されました** | フォームの一覧。そこで送信内容を開いて読みます |
| **新しい連絡先が追加されました** | 連絡先の画面 |
