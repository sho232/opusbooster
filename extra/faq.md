...
すると画面が切り替わります。画面の左側にある「プロジェクトの切り替え」をクリックすると、お使いのアカウントに権限のあるプロジェクト一覧が表示されるので、編集したいプロジェクトに切り替えが可能です。

手順の詳細は[プロジェクトを切り替える](../platform/getting-started/switch-projects.md)をご覧ください。
