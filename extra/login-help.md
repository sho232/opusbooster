...
OpusBoosterのモバイルアプリは、**メールアドレスとパスワード**でログインします。ログイン用のメール（パスワードなしのログイン）はアプリでは使えず、アプリに「パスワードを忘れた」の導線もありません。パスワードをまだ決めていない方・忘れた方は、アプリを開く前に上の「パスワードを使いたいとき」の手順でパスワードを設定してください。
