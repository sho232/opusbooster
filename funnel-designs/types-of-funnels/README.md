---
description: OpusBoosterで使える全ファネルテンプレートの一覧。リード獲得・販売・ウェビナー・会員制など目的別に紹介します。
---
...
「どのファネルから始めればいいか」を価格帯・目的別に整理したガイドはこちらをご覧ください。

{% content-ref url="value-ladder-guide.md" %}
[value-ladder-guide.md](value-ladder-guide.md)
{% endcontent-ref %}
